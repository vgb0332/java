...
public class SaxSVGParseHandler extends DefaultHandler{
	...
	private SVGTreeDrawController control = null;
	...
	public SaxSVGParseHandler(SVGTreeDrawController control, SVGTreeDrawModel model){
	...
	static private void attachAttributeList(DefaultMutableTreeNode node,Attributes atts){
		for (int i=0;i<atts.getLength();i++){
