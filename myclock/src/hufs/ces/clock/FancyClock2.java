...
public class FancyClock2 extends JPanel {
	private int hour;
	private int minute;
	private int second;
	...
	public FancyClock2(int hour, int minute, int second) {
		this.hour = hour;
		this.minute = minute;
		this.second = second;
	}
	...
	protected void paintComponent(Graphics g) {
		...
		int clockRadius =
				(int)(Math.min(getWidth(), getHeight()) * 0.9 * 0.5);  //0.8 ---> 0.9
		int xCenter = getWidth() / 2;
		int yCenter = getHeight() / 2;
		
		//Added by Yongsuk Jung - background
		...
		// Draw circle
		GradientPaint gp1 = new GradientPaint(0, 0, Color.white, 
				xCenter/2, yCenter/2, Color.yellow, true); ///Color changed by me
		g2.setPaint(gp1);
		Shape clockCircle = new Rectangle.Double(xCenter - clockRadius, yCenter - clockRadius,
				2 * clockRadius, 2 * clockRadius);
		g2.fill(clockCircle);
		
		
		//Added by Yongsuk Jung - outline of the circle
		GradientPaint gp2 = new GradientPaint(0, 0, Color.BLUE, 
				xCenter*2-10, yCenter*2-10, Color.cyan, true); ///Color changed by me
		g2.setPaint(gp2);
		...
		g2.drawString("12", xCenter - 10, yCenter - clockRadius+30);
		g2.drawString("9", xCenter - clockRadius + 3, yCenter + 5);
		g2.drawString("3", xCenter + clockRadius - 23, yCenter + 3);
		g2.drawString("6", xCenter - 3, yCenter + clockRadius-5);
