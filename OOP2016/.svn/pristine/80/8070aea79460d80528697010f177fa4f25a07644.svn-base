...
public class SvgWorkerView extends JFrame {

	final String FILE_SEP = System.getProperty("file.separator");

	private SvgWorkerView thisClass = this;
	private SvgWorkerModel model = null;
	private SvgWorkerController controller = null;
	 ...
	 * Create the frame.
	 */
	public SvgWorkerView() {
		this.model = new SvgWorkerModel(this);
		this.controller = new SvgWorkerController(this.model);
